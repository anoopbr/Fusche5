...
if  ((isset($_SESSION)) && ($_SESSION['name'] != ""))
    {
        $res = "<script>alert('".$_SESSION['signid']."');</script>";
        echo $res;
    }else{
                ...
                <div id="priceSlider"></div>
                 <h4>Price Range</h4>
                   ...
                   <h4>Maximum Distance</h4>
                    ...
                    <form id="signUpForm" method="post" action="response.php" accept-charset="utf-8">
                      ...
                      <button name="save-preferences" type="submit" class="next yellow">These are the settings I want! Let \'s go!!</div>
