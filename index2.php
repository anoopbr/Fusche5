<?php session_start(); ob_start(); if ((isset($_SESSION)) && ($_SESSION[ 'name'] !="" )) { //$res="<script>alert('" .$_SESSION[ 'signid']. "');</script>"; $res="<script>var name ='" .$_SESSION[ 'name']. "';</script>"; echo $res; }else{ //$redirect_page="index.php" ; //echo "<script>alert('session exist');</script>"; // header( 'Location: '.$redirect_page); } ob_end_flush(); ?>
...
<head>
    ...
    <script src="scripts/rest1.js"></script>
